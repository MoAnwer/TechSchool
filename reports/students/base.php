<?php
  ...
  if (Auth::isLog()) :
    ...
    // get students in the base stage and count of them
    $students = $student->getStudents("الإبتدائي");
    $CountOfStudents = $student->CountOfStudents("الإبتدائي");
        ...
        <tbody>
          <?php if ($students) : foreach ($students as $student) :?>
            <tr>
              ...
              <td class="border">
              <a class="btn btn-success p-1" href="edit.php?std=<?=$student['id']?>&s=students">تعديل</a> | <a href="delete.php?std=<?=$student['id']?>" class="btn btn-danger p-1">حذف</a>
              </td>
            </tr>
